...
function factory(name,age,knowsJavascript,pets){
  return{
    name:name,
    age:age,
...
function displayProfile(object){

  return 'name:' + ''+ object.name + ' ' + 'age:' + ''+ object.age + '' + 'knowsJavascript:' + object.knowsJavascript + 'pets:' + object.pets
}
...
//to protect a variable inside a function 

// 2- In OOP, what does "this" refer to ?
// to the object on it's left
// 3- What is jQuery?
// 4- what is the diffrence between Closure's methods and The OOP's methods?
// in closures , the variable can be used only inside the function , in oop we can use it outside using this.
// 5- What are variables?
// stores to store values un it or functions .
// 6- 5-What  is the difference between == and === ?
// == not strict , means equal in type , === strict equal should equal in type and value 
//7- What’s the Higher-Order Function ?
// a group of functions that can be used to make dealing with obj and arrays easier .
